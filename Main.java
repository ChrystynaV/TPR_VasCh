...
public class Main {
    public static void main(String[] args) throws Exception {
        Scanner sc = new Scanner(new BufferedReader(new FileReader("C:\\Users\\User\\Desktop\\4 курс\\Теорія прийняття рішень\\matrix.txt")));
        int r = 3;
       ...
       /* for (int i=0; i<r; i++) {
        ...
        double a=0.5;
       // System.out.println("Min:"+returnmax(matrix,0,0)+", "+returnmax(matrix,1,0)+", "+returnmax(matrix,2,0));
        //System.out.println("Max:"+returnmax(matrix,0,1)+", "+returnmax(matrix,1,1)+", "+returnmax(matrix,2,1));
        ...
        //double a=0.5;
        //System.out.println("Min:"+returnmax(matrix,0,1)+", "+returnmax(matrix,1,1)+", "+returnmax(matrix,2,1));
        //System.out.println("Max:"+returnmax(matrix,0,1)+", "+returnmax(matrix,1,1)+", "+returnmax(matrix,2,1));
